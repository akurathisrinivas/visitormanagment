...
<span><?php //echo $company_agreement; ?>Welcome to the Signin system for Nova Agri Tech Limited. During your visit, Please contact any employee for assistance. </span>
<br /><br /><hr></p><br />
<center><a href="admin/index.php" class="btn btn-success btn-lg" /><i class='fa fa-sign-in'></i> Sign In&nbsp;</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <!--<a href="sign_out.php" class="btn btn-danger btn-lg" /><i class='fa fa-sign-out'></i> Sign Out</a>--></center>
<?php } else { ?>
