...
$check_qry="select * from departments where dep_name='$dep_name' and org_id='$org_id' and user_id='$account_id'  and delete_status='1' ";
...
if(!empty($row)) {
	echo '<div class="col-xs-12"><div class="alert alert-danger alert-dismissable">
                  ...
                  <a href="http://novaagri.in/visitormanagment/admin/add_departments.php"><i class="fa fa-reply"></i> Back</a>
                  </button>
                  </div></section></div>';
	include_once ('bottom.php');
	exit();
...
$sql_insert_dep = "INSERT INTO departments  SET dep_name='$dep_name',org_id='$org_id',user_id='$account_id',status='1',delete_status='1',created_on='$created_date' ";//exit;
      ...
      <div class="row">
		  ...
		  <div class="box box-primary">
               <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				  ...
				  <br /><h4>
<?php 
echo "<label>Department Name:</label> <br /><input type='text' name='dep_name' class='form-control' autofocus required ><br />";
?>	
<!--<label>Active</label>
...
<input type="text" name="new_dep" value="create_newemp" hidden>
                   <button type="submit" class="btn btn-warning" onclick="goBack()"><i class="fa fa-reply"></i> Back</button> <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Create Department</button>
                  </div></div>
                </form>
          </div>
        </section>
