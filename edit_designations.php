...
$cid=$_GET['cid'];
$query="select * from designations where id='$cid' and delete_status='1' ";
...
$id=$_POST['id'];
$check_qry="select * from designations where des_name='$des_name' and org_id='$org_id' and user_id='$account_id'  and delete_status='1' and id!='$id' ";
...
if(!empty($row)) {
	echo '<div class="col-xs-12"><div class="alert alert-danger alert-dismissable">
                  ...
                  <a href="http://novaagri.in/visitormanagment/admin/edit_designations.php?cid='.$id.'"><i class="fa fa-reply"></i> Back</a>
                  </button>
                  </div></section></div>';
	include_once ('bottom.php');
	exit();
...
$sql_insert_dep = " UPDATE designations SET des_name = '$des_name',modified_on='$modified_on' WHERE id ='$id'";//exit;
      ...
      <div class="row">
		  ...
		  <div class="box box-primary">
               <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                  <div class="box-body">
				  <br /><h4>
<?php $rdes_name=$record['des_name'];
echo "<label>Designation Name:</label> <br /><input type='text' name='des_name' class='form-control' autofocus required value='$rdes_name'>
...
<input type="text" name="new_des" value="create_newemp" hidden>
                   <button type="submit" class="btn btn-warning" ><a href="http://novaagri.in/visitormanagment/admin/designations.php"><i class="fa fa-reply"></i> Back</a></button> <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Update Designation</button>
                  </div></div>
                </form>
          </div>
        </section>
